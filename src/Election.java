...
public class Election {
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 1461, 633);
		...
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\Harshith Golla\\Documents\\java images\\EMS logo.PNG"));
		lblNewLabel_1.setBounds(464, 10, 481, 220);
		frame.getContentPane().add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\Harshith Golla\\Documents\\java images\\pollindia.JPG"));
		lblNewLabel_2.setBounds(139, 118, 194, 348);
		frame.getContentPane().add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\Harshith Golla\\Documents\\java images\\lions.JPEG"));
